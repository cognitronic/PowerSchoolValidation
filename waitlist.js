...
function setNames() {
    ...
    $("#motherlastname").val(aMomName[0]);
    $("#motherfirstname").val(aMomName[1]);
...
$(document).ready(
        function() {
            ...
            $(window).scroll(function() {
                document.getElementById("lastfirst").value = document.getElementById("last_name").value + ", " + document.getElementById("first_name").value;
            });
		...
		phone_number.match(/^(1-?)?(\([2-9]\d{2}\)|[2-9]\d{2})-?[2-9]\d{2}-?\d{4}$/);
            ...
            $("#lastname").change(function() {
                //alert($("#lastname").val() + ', ' + $("#firstname").val());
            ...
            jQuery("#newstudentForm").validate(
	        {
	            ...
	            messages:
	            {
	                ...
	                dateofapplication: "Please enter a valid date.",
	                enrollmentdate: "Please enter a valid date."
	            },
